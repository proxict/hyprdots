...
## Type: Dict
#c.aliases = {
#    'news': 'open http://thehackernews.com/',
#    'News': 'open -t http://thehackernews.com/'
#}
...
## Type: QssColor
c.colors.statusbar.command.private.bg = '#9000ff'
...
## Type: QtColor
c.colors.tabs.selected.even.bg = '#FABD2F'

## Foreground color of selected even tabs.
## Type: QtColor
c.colors.tabs.selected.even.fg = '#2c2c2c'
...
## Type: Font
c.fonts.default_family = ["0xProto Nerd Font Propo", "FiraCode Nerd Font Propo", "Noto Sans Mono", "DejaVuSansM Nerd Font Mono", "Monospace", "DejaVu Sans Mono", "Bitstream Vera Sans Mono", "Liberation Mono", "monospace"]
...
## Type: String
## Valud values:
##    - always: Always show the favicons
##    - never: Always hide the favicons
##    - pinned: Only show favicons on pinned tabs
c.tabs.favicons.show = 'always'

## Padding for tab indicators
## Type: Padding
c.tabs.indicator.padding = {'top': 0, 'bottom': 0, 'left': 0, 'right': 2}
...
## Type: Padding
c.tabs.padding = {'top': 2, 'bottom': 2, 'left': 0, 'right': 2}
